...
return [
    ...
    [ // $staticRoutes
        ...
        '/template' => [[['_route' => 'home_template', '_controller' => 'App\\Controller\\DefaultController::template'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        192 => [[['_route' => 'user_show', '_controller' => 'App\\Controller\\UserController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        205 => [[['_route' => 'user_edit', '_controller' => 'App\\Controller\\UserController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        213 => [
