...
class __TwigTemplate_f09911567e9e07f0f97cd9a1a27653e6f7a878c02a981d7f02122a605e0e27cd extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Voulez-vous vraiment supprimer cet enregistrement ?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Voulez-vous vraiment supprimer cet enregistrement ?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger\">Delete</button>
</form>
", "user/_delete_form.html.twig", "C:\\laragon\\www\\projet_symf\\templates\\user\\_delete_form.html.twig");
    }
}
