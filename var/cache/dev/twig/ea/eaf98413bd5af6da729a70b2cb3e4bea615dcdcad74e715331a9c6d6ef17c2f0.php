...
/* user/show.html.twig */
class __TwigTemplate_7861119640df62eababadc36343aa8cde3988612a49410e50f647a0ab3b1fe36 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 25
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 25, $this->source); })()), "nomComplet", [], "any", false, false, false, 25), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <p><a class=\"btn btn-warning\" href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31)]), "html", null, true);
        echo "\" role=\"button\">Edit</a></p>
...
";
    ...
    {
        return array (  135 => 33,  130 => 31,  126 => 30,  118 => 25,  111 => 21,  104 => 17,  97 => 13,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Détail User{% endblock %}
...
<div class=\"container\">
    ...
    <p><a class=\"btn btn-warning\" href=\"{{ path('user_edit', {'id': user.id}) }}\" role=\"button\">Edit</a></p>

    {{ include('user/_delete_form.html.twig') }}
</div>
{% endblock %}
", "user/show.html.twig", "C:\\laragon\\www\\projet_symf\\templates\\user\\show.html.twig");
    }
}
