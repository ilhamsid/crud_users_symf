...
class __TwigTemplate_78369670d93f4a5b02339472dd42a31de5c94ee453f867eb5396f8626fa6d491 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <p><button class=\"btn btn-primary\">";
        // line 3
        echo twig_escape_filter($this->env, (((isset($context["button_label"]) || array_key_exists("button_label", $context))) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Enregistrer")) : ("Enregistrer")), "html", null, true);
        echo "</button></p>
";
        // line 4
...
";
    ...
    {{ form_widget(form) }}
    <p><button class=\"btn btn-primary\">{{ button_label|default('Enregistrer') }}</button></p>
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\laragon\\www\\projet_symf\\templates\\user\\_form.html.twig");
    }
}
